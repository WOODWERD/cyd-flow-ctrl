...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(font_inter_14sb) LV_FONT_DECLARE(font_inter_16sb) LV_FONT_DECLARE(font_inter_20sb) LV_FONT_DECLARE(font_plex_14m)
